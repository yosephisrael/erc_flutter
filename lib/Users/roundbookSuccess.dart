...
import 'package:flutter/widgets.dart'; // Assuming this is your correct import path

class RoundBookingSuccess extends StatefulWidget {
  ...
  @override
  State<RoundBookingSuccess> createState() => _RoundBookingSuccessState();
}

class _RoundBookingSuccessState extends State<RoundBookingSuccess> {
  String fname = '';
  String lname = '';
  String email = '';
  String phone = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      resizeToAvoidBottomInset:
          false, // Prevents compression of bottom container when keyboard appears
      body: Center(
        child: Stack(
          children: [
            const SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    '${(2 * int.parse(widget.pricingDetailing)).toString()} ETB',
                                    style: const TextStyle(
                                      fontFamily: 'DMSans',
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20,
