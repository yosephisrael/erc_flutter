...
class BottomManagePaidJourney extends StatefulWidget {
  final String pfrom;
  final String pto;
  const BottomManagePaidJourney(
      {super.key, required this.pfrom, required this.pto});
  @override
  _ManagePaidJourneyState createState() => _ManagePaidJourneyState();
}

class _ManagePaidJourneyState extends State<BottomManagePaidJourney> {
  ...
  int _selectedIndex = 2; // Define _selectedIndex variable here
