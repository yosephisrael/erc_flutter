...
class RoundPayment extends StatefulWidget {
  ...
  @override
  _RoundPaymentState createState() => _RoundPaymentState();
}

class _RoundPaymentState extends State<RoundPayment> {
  ...
  void initState() {
    super.initState();
    initializeFields();
    String newPrice = (int.parse(widget.pricingDetailing) * 2).toString();
    amountController.text = newPrice;
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(
                          '${(2 * int.parse(widget.pricingDetailing)).toString()} ETB', // Double the price
                          style: const TextStyle(
                            fontFamily: 'DMSans',
                            fontWeight: FontWeight.bold,
                            fontSize: 15,
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => RoundfinalQR(
                ...
                txRef: TxRef,
                returnstartingPoint: widget.returnstartPoint,
                returndestinationingPoint: widget.returndestinationPoint,
                returnStartingtime: widget.returnStarttime,
                returnFinishingtime: widget.returnFinishtime,
                selectedReturningDate: widget.selectedReturnDate,
              ),
            ),
          );
        },
