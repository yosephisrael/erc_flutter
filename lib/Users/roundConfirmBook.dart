import 'package:erbs/Users/roundHardBerthSelection.dart';
import 'package:erbs/Users/roundHardSeatSelection.dart';
import 'package:erbs/Users/roundSoftBerthSelection.dart';
...
class RoundConfirmBook extends StatelessWidget {
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Material(
                              elevation:
                                  2, // Adjust the elevation value as needed
                              shadowColor:
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  '${(2 * int.parse(pricing)).toString()} ETB', // Double the price
                                  style: const TextStyle(
                                    fontFamily: 'DMSans',
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
  ...
  void SeatSelectionScreen(BuildContext context) {
    if (selectedclass == 'Hard Seat') {
      Navigator.of(context).push(MaterialPageRoute(
        builder: (BuildContext context) => RoundHardSeatMapScreen(
          ...
          selectedReturningdate: selectedReturndate,
          rhsfrom: rcfrom,
          rhsto: rcto,
        ),
      ));
      ...
      Navigator.of(context).push(MaterialPageRoute(
        builder: (BuildContext context) => RoundHardBerthSeatMapScreen(
          startpoint: startpoint,
          destinationpoint: destinationpoint,
          starttime: starttime,
          finishtime: finishtime,
      ...
      Navigator.of(context).push(MaterialPageRoute(
        builder: (BuildContext context) => RoundSoftBerthSeatMapScreen(
          startpoint: startpoint,
          destinationpoint: destinationpoint,
          starttime: starttime,
          finishtime: finishtime,
