...
class HardBerthSeat {
  ...
  HardBerthSeat(
    this.seatNumber,
    this.compartmentIndex,
    this.isBooked,
    this.isReserved,
  );
}

class HardBerthSeatMapScreen extends StatefulWidget {
  ...
  HardBerthSeatMapScreen({
    ...
    required this.hbfrom,
    required this.hbto,
  });

  @override
  _HardBerthSeatMapScreenState createState() => _HardBerthSeatMapScreenState();
}

class _HardBerthSeatMapScreenState extends State<HardBerthSeatMapScreen> {
  late List<List<List<List<HardBerthSeat>>>> compartments;
  HardBerthSeat? selectedSeat; // Store the selected seat
  String selectedSeatInfo = ''; // Store selected seat info
