...
class RoundSoftBerthSeatMapScreen extends StatefulWidget {
  ...
  final String rsbfrom;
  final String rsbto;

  RoundSoftBerthSeatMapScreen({
    ...
    required this.rsbfrom,
    required this.rsbto,
  });
  @override
  _RoundSoftBerthSeatMapScreenState createState() =>
      _RoundSoftBerthSeatMapScreenState();
}

class _RoundSoftBerthSeatMapScreenState
    extends State<RoundSoftBerthSeatMapScreen> {
