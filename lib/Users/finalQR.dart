...
class finalQR extends StatefulWidget {
  final String fname;
  final String lname;
  final String email;
  final String phone;
  ...
  @override
  State<finalQR> createState() => _finalQRState();
}

class _finalQRState extends State<finalQR> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> addPassengersPaid(String TxRef) async {
    try {
      ...
      if (widget.selclass == 'Hard Seat') {
        selectedCollection = 'Hard Seat Passenger';
      } else if (widget.selclass == 'Hard Berth') {
        selectedCollection = 'Hard Berth Passenger';
      } else if (widget.selclass == 'Soft Berth') {
        selectedCollection = 'Soft Berth Passenger';
      } else {
